...
@section('isi-contentLanding')
    ...
    <div class="container-xxl py-5">
        <div class="text-center mx-auto wow fadeIn" data-wow-delay="0.1s"
            ...
            <h2 class="display-5 mb-5">Data Kendaraan Anda</h2>
        </div>
        <div class="container">
            <div class="row g-5 justify-content-center mb-5">
                <div class="col text-center">
                    @include('landing.vehicle.vehicle-store')
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="bg-light text-center h-100 p-5">
                            <div class="btn-square bg-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                                {{-- <i class="fa fa-car"></i> --}}
                                {{ QrCode::size(250)->generate("$v->id#masuk") }}
                            </div>
                            <h4 class="mb-3">{{ $v->nomor }}</h4>
                            <p class="mb-2">Silahkan Tampilkan QR-Code</p>
                            <button type="button" class="btn btn-primary px-4" data-bs-toggle="modal"
                                data-bs-target="#qrcode{{ $v->id }}">
                                QR-Code
                                <i class="fa fa-qrcode"></i>
                            </button>
                            <div class="modal fade" id="qrcode{{ $v->id }}" tabindex="-1"
