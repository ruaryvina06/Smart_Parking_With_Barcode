                        ...
                        <div class="card">
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h6 class="text-muted font-semibold">Pemarkir</h6>
                                        <h6 class="font-extrabold mb-0">{{ $pemarkir }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $kendara }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $lokas }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
